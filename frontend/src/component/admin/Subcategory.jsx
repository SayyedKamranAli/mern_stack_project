...
import { createSubCategory, getAllSubCategory, getAllCategory } from '../../actions/categoryAction'
...
export default function SubCategoryPage() {
    ...
    const { subcategories } = useSelector((state) => state.allsubcategory)
    ...
    const handleCategoryId = (option) => {
        console.log('option value checking 1', option)
    ...
    const fetchcategorydata = async () => {
        try {
            const response = await axios.get('/api/V1/getallcategory');
    ...
    const categoryName = (categoryId) => {
        let targetName = categories.find((item) => item._id === categoryId);
        console.log("searching name", targetName)
    ...
    const columns = [
        ...
        { field: 'parentcategoryname', headerName: "Parent-category Name", width: 150, editable: true },
    ...
    subcategories && subcategories.forEach((item) => {
        console.log('users real sub data', item);
        ...
        rows.push({
            ...
            parentcategoryname: categoryName(item.categoryId)
            ...
            <Grid container className={classes.contentContainer}>
                ...
                <Grid item xs={10} style={{ paddingLeft: "20px" }}>
                    <Box sx={{ height: 400, width: '100%', display: 'flex', flexDirection: 'column' }}>
                        <Typography variant="h2"> Sub-Category</Typography>
                        <Button
                            variant="contained"
                            color="primary"
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12}>
                                        <TextField
                                            ...
                                            onChange={(event) => handleCategoryId(event.target.value)}
